...
parser.add_argument('--network_name', default='nyu_seg_sn',
...
criterion = SceneNetLoss(dataset, TASKS, TASKS_NUM_CLASS,
                         LAMBDAS, device, DATA_ROOT)
...
batch_update = 16
net = train(net, dataset, criterion, optimizer, scheduler, train_loader, test_loader, network_name,
...
evaluator = SceneNetEval(device, TASKS, TASKS_NUM_CLASS,
                         IMAGE_SHAPE, dataset, DATA_ROOT)
