...
def get_gradcam_image_sn(img_names, attributions, image):
...
def plot_avg_irof_curve_sn(histories):
...
if __name__ == "__main__":
    ...
    for i, gt_batch in enumerate(test_loader):
        ...
        get_gradcam_image_sn(img_names, attributions, image)
    ...
    plot_all_irof_curves_sn(all_histories)
    plot_avg_irof_curve_sn(all_histories)
