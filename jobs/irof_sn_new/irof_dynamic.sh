...
tar xzf /scratch/$USER/explanations/all/sn/dynamic/job_15357437/results.tar.gz -C $TMPDIR/explanations
...
# Run training
python3 irof_sn_final_hbrk.py --method dynamic --task sn

########### GET RESULTS

# Save models by compressing and copying from TMPDIR
mkdir -p /scratch/$USER/irof_new/sn/dynamic/job_${SLURM_JOBID}
tar czvf /scratch/$USER/irof_new/sn/dynamic/job_${SLURM_JOBID}/results.tar.gz $TMPDIR/results