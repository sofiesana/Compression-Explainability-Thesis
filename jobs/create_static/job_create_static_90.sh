...
mkdir -p /scratch/$USER/pruned_models/static/90/job_${SLURM_JOBID}
tar czvf /scratch/$USER/pruned_models/static/90/job_${SLURM_JOBID}/results.tar.gz $TMPDIR/results