...
tar xzf /scratch/s4716671/pruned_models/pt/80/baseline2/results.tar.gz -C $TMPDIR/pt
...
tar czvf /scratch/$USER/pruned_models/pt/80/baseline2/trained_results.tar.gz $TMPDIR/results