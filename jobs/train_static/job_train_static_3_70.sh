...
tar xzf /scratch/s4716671/pruned_models/static3/70/static3/results.tar.gz -C $TMPDIR/pt
...
# Run training
python3 launch_training.py --dataset nyuv2 --method disparse_static --ratio 70 --dest $TMPDIR/results --source $TMPDIR/pt

############ SAVING:

# Save models by compressing and copying from TMPDIR
tar czvf /scratch/$USER/pruned_models/static/70/static3/trained_results.tar.gz $TMPDIR/results