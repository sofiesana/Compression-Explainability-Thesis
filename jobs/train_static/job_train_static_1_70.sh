...
tar xzf /scratch/s4716671/pruned_models/static/70/static1/results.tar.gz -C $TMPDIR/pt
...
tar czvf /scratch/$USER/pruned_models/static/70/static1/trained_results.tar.gz $TMPDIR/results