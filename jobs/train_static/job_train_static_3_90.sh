...
tar xzf /scratch/s4716671/pruned_models/static3/90/static3/results.tar.gz -C $TMPDIR/pt
...
tar czvf /scratch/$USER/pruned_models/static/90/static3/trained_results.tar.gz $TMPDIR/results