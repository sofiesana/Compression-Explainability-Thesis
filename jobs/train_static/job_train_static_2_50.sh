...
tar xzf /scratch/s4716671/pruned_models/static2/50/static2/results.tar.gz -C $TMPDIR/pt
...
tar czvf /scratch/$USER/pruned_models/static/50/static2/trained_results.tar.gz $TMPDIR/results